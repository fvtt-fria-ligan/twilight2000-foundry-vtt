 ...
 * ===============================================================================
 * Author: @Stefouch
 * Version: 2.0.0     for:     Foundry VTT V8 (0.8.8)
 * Licence: MIT
 * ===============================================================================
 * Content:
 * 
...
export class YearZeroDie extends Die {
  constructor(termData = {}) {
    ...
    // TODO add support for a maxPush directly inside the DieTerm (might be useful later)
  ...
  nopush() {
    // TODO
    console.warn('YZUR | YearZeroDie#nopush() is not implemented yet.');
  }
